...
ALTER TABLE ESTUDIANTES ADD CONSTRAINT CK_PLAN_ESTUDIANTE 
CHECK (PLAN IN(11,12,13,14,15));
...
INSERT INTO ESTUDIANTES(ID,MATRICULA,NOMBRES, APELLIDOS, PLAN,IDCARRERA)VALUES
